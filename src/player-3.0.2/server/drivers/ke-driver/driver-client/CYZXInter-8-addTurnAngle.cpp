...
char ConvertIntToChar[51]={'\0','\x01','\x02','\x03','\x04','\x05','\x06','\x07','\x08','\x09',
...
//position2d
void CYZXInter::pos2dSet4TiresPos(int id1,int id2,int id3,int id4,int pos,int speed){
	player_opaque_data_t popa;
...
void CYZXInter::pos2dSet4Tires(int id1,int id2,int id3,int id4,int sp1,int sp2,int sp3,int sp4){
	player_opaque_data_t popa;
