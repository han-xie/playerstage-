...
/*
 * A simple opaque of how to write a driver that will be built as a
 * shared object.
 */
...
#define LOGFILENAME "/mnt/yaffs/test/CYZXopaquedriver.log"
...
int opaquedriver::MainSetup() {
	puts("Opaque driver initialising");
...
void opaquedriver::MainQuit() {
	...
	// Here you would shut the device down by, for Opaque, closing a
	// serial port.

	puts("Opaque driver has been shutdown");
}
int opaquedriver::dealOpaqueMFCAPComReq(myOpaqueSt *popa, myOpaqueSt *pr) {
	pr->type = popa->type;
...
int opaquedriver::dealOpaqueMFCAP(QueuePointer & resp_queue,
...
int opaquedriver::dealOpaqueDIO(QueuePointer & resp_queue, player_msghdr * hdr,
		void * data) {
	player_opaque_data_t *opaquedata = (player_opaque_data_t *) data;
	myOpaqueSt *popa = (myOpaqueSt *) opaquedata->data;
...
int opaquedriver::dealOpaquePosition2dComReq(myOpaqueSt *popa,
		myOpaqueSt *res) {
	res->type = popa->type;
...
int opaquedriver::dealOpaquePosition2d(QueuePointer & resp_queue,
		player_msghdr * hdr, void * data) {
	player_opaque_data_t *opaquedata = (player_opaque_data_t *) data;
...
int opaquedriver::dealOpaqueBK(QueuePointer & resp_queue, player_msghdr * hdr,
		void * data) {
	pid_t pid;
	player_opaque_data_t *opaquedata = (player_opaque_data_t *) data;
...
int opaquedriver::dealOpaqueSR(QueuePointer & resp_queue, player_msghdr * hdr,
		void * data) {
	return -1;
}
int opaquedriver::deaperDealAIO(int t, int type) {
...
int opaquedriver::dealOpaqueAIOComReq(myOpaqueSt *popa, myOpaqueSt *res) {
	res->type = popa->type;
	res->subtype = popa->subtype;
...
int opaquedriver::dealOpaqueAIO(QueuePointer & resp_queue, player_msghdr * hdr,
		void * data) {
	player_opaque_data_t *opaquedata = (player_opaque_data_t *) data;
	myOpaqueSt *popa = (myOpaqueSt *) opaquedata->data;
...
int opaquedriver::dealOpaqueMessages(QueuePointer & resp_queue,
		player_msghdr * hdr, void * data) {
	/*
	 * struct myOpaqueSt{
	 int type;
...
int opaquedriver::dealPosMessages(QueuePointer & resp_queue,
		player_msghdr * hdr, void * data) {
...
int opaquedriver::dealLaserMessages(QueuePointer & resp_queue,
		player_msghdr * hdr, void * data) {
	/*
...
int opaquedriver::dealBlobFinderMessages(QueuePointer & resp_queue,
		player_msghdr * hdr, void * data) {
	/*
...
void opaquedriver::Position2dPublish() {
...
void opaquedriver::BlobfinderPublish() {
...
void opaquedriver::LaserPublish() {
	float dioV[DIOPORTS];
	float aioV[AIOPORTS];
...
void opaquedriver::Main() {
	...
	for (;;) {
		...
		// Sleep (you might, for Opaque, block on a read() instead)
		usleep(100000);
	}
}
