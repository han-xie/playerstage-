...
int demoFCYZXIbkMFSetServo(int index) {
	...
	if ((buffer[index][17] == 'R' || buffer[index][17] == 'r')
			&& (buffer[index][18] == 'O' || buffer[index][18] == 'o')
			&& (buffer[index][19] == 'T' || buffer[index][19] == 't')
			&& (buffer[index][20] == 'A' || buffer[index][20] == 'a')
			&& (buffer[index][21] == 'S' || buffer[index][21] == 's')
			&& (buffer[index][22] == 'P' || buffer[index][22] == 'p')
			&& (buffer[index][23] == 'D' || buffer[index][23] == 'd')
		...
		buffer[index][0] = '\0';
	} else if ((buffer[index][17] == 'P' || buffer[index][17] == 'p')
			&& (buffer[index][18] == 'O' || buffer[index][18] == 'o')
			&& (buffer[index][19] == 'S' || buffer[index][19] == 's')
		...
		buffer[index][0] = '\0';
	} else if ((buffer[index][17] == 'M' || buffer[index][17] == 'm')
			&& (buffer[index][18] == 'O' || buffer[index][18] == 'o')
			&& (buffer[index][19] == 'D' || buffer[index][29] == 'd')
			&& (buffer[index][20] == 'E' || buffer[index][20] == 'e')
...
int demoFCYZXIbk(int index) {
	 ...
	 * */
	if ((buffer[index][7] == 'M' || buffer[index][7] == 'm')
			&& (buffer[index][8] == 'F' || buffer[index][8] == 'f')
			&& (buffer[index][9] == 'S' || buffer[index][9] == 's')
			&& (buffer[index][10] == 'E' || buffer[index][10] == 'e')
			&& (buffer[index][11] == 'T' || buffer[index][11] == 't')
			&& (buffer[index][12] == 'S' || buffer[index][12] == 's')
			&& (buffer[index][13] == 'E' || buffer[index][13] == 'e')
			&& (buffer[index][14] == 'R' || buffer[index][14] == 'r')
			&& (buffer[index][15] == 'V' || buffer[index][15] == 'v')
			&& (buffer[index][16] == 'O' || buffer[index][16] == 'o')) {
		rv = demoFCYZXIbkMFSetServo(index);
	} else if ((buffer[index][7] == 'G' || buffer[index][7] == 'g')
			&& (buffer[index][8] == 'E' || buffer[index][8] == 'e')
			&& (buffer[index][9] == 'T' || buffer[index][9] == 't')
			&& (buffer[index][10] == 'U' || buffer[index][10] == 'u')
			&& (buffer[index][11] == 'L' || buffer[index][11] == 'l')
			&& (buffer[index][12] == 'T' || buffer[index][12] == 't')
			&& (buffer[index][13] == 'R' || buffer[index][13] == 'r')
			&& (buffer[index][14] == 'A' || buffer[index][14] == 'a')
			&& (buffer[index][15] == 'S' || buffer[index][15] == 's')
			&& (buffer[index][16] == 'O' || buffer[index][16] == 'o')
			&& (buffer[index][17] == 'N' || buffer[index][17] == 'n')
			&& (buffer[index][18] == 'I' || buffer[index][18] == 'i')
			&& (buffer[index][19] == 'C' || buffer[index][19] == 'c')
			&& (buffer[index][20] == '(' || buffer[index][20] == ' ')) {
		int tdis = pcyzxic->bkGetUltrasonic();
		itoa(tdis, buffer[index], 10);
	} else if ((buffer[index][7] == 'M' || buffer[index][7] == 'm')
			&& (buffer[index][8] == 'P' || buffer[index][8] == 'P')
			&& (buffer[index][9] == '3')
			&& (buffer[index][10] == 'P' || buffer[index][10] == 'p')
			&& (buffer[index][11] == 'L' || buffer[index][11] == 'l')
			&& (buffer[index][12] == 'A' || buffer[index][12] == 'a')
			&& (buffer[index][13] == 'Y' || buffer[index][13] == 'y')
...
int demoFCYZXIdio(int index) {
	 ...
	 */
	int rv;
	if ((buffer[index][8] == 'D' || buffer[index][8] == 'd')
			&& (buffer[index][9] == 'I' || buffer[index][9] == 'i')
			&& (buffer[index][10] == 'G' || buffer[index][10] == 'g')
			&& (buffer[index][11] == 'I' || buffer[index][11] == 'i')
			&& (buffer[index][12] == 'O' || buffer[index][12] == 'o')
			&& (buffer[index][13] == 'U' || buffer[index][13] == 'u')
			&& (buffer[index][14] == 'T' || buffer[index][14] == 't')
			&& (buffer[index][15] == 'P' || buffer[index][15] == 'p')
			&& (buffer[index][16] == 'U' || buffer[index][16] == 'u')
			&& (buffer[index][17] == 'T' || buffer[index][17] == 't')
		...
		buffer[index][0] = '\0';
	} else if ((buffer[index][8] == 'G' || buffer[index][8] == 'g')
			&& (buffer[index][9] == 'E' || buffer[index][9] == 'e')
			&& (buffer[index][10] == 'T' || buffer[index][10] == 't')
			&& (buffer[index][11] == 'D' || buffer[index][11] == 'd')
			&& (buffer[index][12] == 'I' || buffer[index][12] == 'i')
			&& (buffer[index][13] == 'G' || buffer[index][13] == 'g')
			&& (buffer[index][14] == 'I' || buffer[index][14] == 'i')
			&& (buffer[index][15] == 'I' || buffer[index][15] == 'i')
			&& (buffer[index][16] == 'N' || buffer[index][16] == 'n')
			&& (buffer[index][17] == 'P' || buffer[index][17] == 'p')
			&& (buffer[index][18] == 'U' || buffer[index][18] == 'u')
			&& (buffer[index][19] == 'T' || buffer[index][19] == 't')
			&& (buffer[index][20] == '(' || buffer[index][20] == ' ')) {
		int ti[1] = { 0 };
		int *tp = &ti[0];
	...
	} else if ((buffer[index][8] == 'S' || buffer[index][8] == 's')
			&& (buffer[index][9] == 'E' || buffer[index][9] == 'e')
			&& (buffer[index][10] == 'T' || buffer[index][10] == 't')
			&& (buffer[index][11] == 'P' || buffer[index][11] == 'p')
			&& (buffer[index][12] == 'O' || buffer[index][12] == 'o')
			&& (buffer[index][13] == 'R' || buffer[index][13] == 'r')
			&& (buffer[index][14] == 'T' || buffer[index][14] == 't')
			&& (buffer[index][15] == 'D' || buffer[index][15] == 'd')
			&& (buffer[index][16] == 'I' || buffer[index][16] == 'i')
			&& (buffer[index][17] == 'R' || buffer[index][17] == 'r')
			&& (buffer[index][18] == 'E' || buffer[index][18] == 'e')
			&& (buffer[index][19] == 'C' || buffer[index][19] == 'c')
			&& (buffer[index][20] == 'T' || buffer[index][20] == 't')
			&& (buffer[index][21] == '(' || buffer[index][21] == ' ')) {
		int ti[1] = { 0 };
		int *tp = &ti[0];
...
int demoFCYZXIaio(int index) {
	 ...
	 */
	int rv;
	if ((buffer[index][8] == 'C' || buffer[index][8] == 'c')
			&& (buffer[index][9] == 'O' || buffer[index][9] == 'o')
			&& (buffer[index][10] == 'M' || buffer[index][10] == 'm')
		...
		itoa(t, buffer[index], 10);
	} else if ((buffer[index][8] == 'C' || buffer[index][8] == 'c')
			&& (buffer[index][9] == 'O' || buffer[index][9] == 'o')
			&& (buffer[index][10] == 'M' || buffer[index][10] == 'm')
			&& (buffer[index][11] == 'I' || buffer[index][11] == 'i')
			&& (buffer[index][12] == 'N' || buffer[index][12] == 'n')
			&& (buffer[index][13] == 'F' || buffer[index][13] == 'f')
			&& (buffer[index][14] == 'R' || buffer[index][14] == 'r')
			&& (buffer[index][15] == 'A' || buffer[index][15] == 'a')
			&& (buffer[index][16] == 'R' || buffer[index][16] == 'r')
			&& (buffer[index][17] == 'E' || buffer[index][17] == 'e')
			&& (buffer[index][18] == 'D' || buffer[index][18] == 'd')
			&& (buffer[index][19] == '(' || buffer[index][19] == ' ')) {
		int ti[1] = { 0 };
		int *tp = &ti[0];
...
int demoFCYZXIpos2d(int index) {
	 ...
	 */
	if ((buffer[index][10] == 'S' || buffer[index][10] == 's')
			&& (buffer[index][11] == 'E' || buffer[index][11] == 'e')
			&& (buffer[index][12] == 'T' || buffer[index][12] == 't')
			&& (buffer[index][13] == '4')
			&& (buffer[index][14] == 'T' || buffer[index][14] == 't')
			&& (buffer[index][15] == 'I' || buffer[index][15] == 'i')
			&& (buffer[index][16] == 'R' || buffer[index][16] == 'r')
			&& (buffer[index][17] == 'E' || buffer[index][17] == 'e')
			&& (buffer[index][18] == 'S' || buffer[index][18] == 's')
			&& (buffer[index][19] == '(' || buffer[index][19] == ' ')) {
		...
		pcyzxic->pos2dSet4Tires(*(tp + 0), *(tp + 1), *(tp + 2), *(tp + 3),
				*(tp + 4), *(tp + 5), *(tp + 6), *(tp + 7));
		buffer[index][0] = '\0';
	} else if ((buffer[index][10] == 'S' || buffer[index][10] == 's')
			&& (buffer[index][11] == 'E' || buffer[index][11] == 'e')
			&& (buffer[index][12] == 'T' || buffer[index][12] == 't')
			&& (buffer[index][13] == '4')
			&& (buffer[index][14] == 'T' || buffer[index][14] == 't')
			...
			&& (buffer[index][17] == 'E' || buffer[index][17] == 'e')
			&& (buffer[index][18] == 'S' || buffer[index][18] == 's')
			&& (buffer[index][19] == 'P' || buffer[index][19] == 'p')
			&& (buffer[index][20] == 'O' || buffer[index][20] == 'o')
			&& (buffer[index][21] == 'S' || buffer[index][21] == 's')
...
int demoFCYZXIcap(int index) {
	 ...
	 */
	if ((buffer[index][8] == 'C' || buffer[index][8] == 'c')
			&& (buffer[index][9] == 'A' || buffer[index][9] == 'a')
			&& (buffer[index][10] == 'P' || buffer[index][10] == 'p')
			&& (buffer[index][11] == 'G' || buffer[index][11] == 'g')
			&& (buffer[index][12] == 'E' || buffer[index][12] == 'e')
			&& (buffer[index][13] == 'T' || buffer[index][13] == 't')
			&& (buffer[index][14] == 'C' || buffer[index][14] == 'c')
			&& (buffer[index][15] == 'E' || buffer[index][15] == 'e')
			&& (buffer[index][16] == 'N' || buffer[index][16] == 'n')
			&& (buffer[index][17] == 'T' || buffer[index][17] == 't')
			&& (buffer[index][18] == 'E' || buffer[index][18] == 'e')
			&& (buffer[index][19] == 'R' || buffer[index][19] == 'r')
			&& (buffer[index][20] == 'X' || buffer[index][20] == 'x')
			&& (buffer[index][21] == '(' || buffer[index][21] == ' ')) {
		...
		itoa(t, buffer[index], 10);
			...
			&& (buffer[index][18] == 'E' || buffer[index][18] == 'e')
			&& (buffer[index][19] == 'R' || buffer[index][19] == 'r')
			&& (buffer[index][20] == 'Y' || buffer[index][20] == 'y')
			&& (buffer[index][21] == '(' || buffer[index][21] == ' ')) {
		...
		itoa(t, buffer[index], 10);
			...
			&& (buffer[index][12] == 'E' || buffer[index][12] == 'e')
			&& (buffer[index][13] == 'T' || buffer[index][13] == 't')
			&& (buffer[index][14] == 'S' || buffer[index][14] == 's')
			&& (buffer[index][15] == 'U' || buffer[index][15] == 'u')
			&& (buffer[index][16] == 'M' || buffer[index][16] == 'm')
		...
		itoa(t, buffer[index], 10);
			...
			&& (buffer[index][9] == 'A' || buffer[index][9] == 'a')
			&& (buffer[index][10] == 'P' || buffer[index][10] == 'p')
			&& (buffer[index][11] == 'S' || buffer[index][11] == 's')
			&& (buffer[index][12] == 'E' || buffer[index][12] == 'e')
			&& (buffer[index][13] == 'T' || buffer[index][13] == 't')
			&& (buffer[index][14] == 'H' || buffer[index][14] == 'h')
...
#endif
	if ((buffer[index][5] == 'B' || buffer[index][5] == 'b')
			&& (buffer[index][6] == 'K' || buffer[index][6] == 'k')) {
		rv = demoFCYZXIbk(index);
	} else if ((buffer[index][5] == 'S' || buffer[index][5] == 's')
			&& (buffer[index][6] == 'R' || buffer[index][6] == 'r')) {
		rv = -1;
	} else if ((buffer[index][5] == 'D' || buffer[index][5] == 'd')
			&& (buffer[index][6] == 'I' || buffer[index][6] == 'i')
			&& (buffer[index][7] == 'O' || buffer[index][7] == 'o')) {
		rv = demoFCYZXIdio(index);
	} else if ((buffer[index][5] == 'A' || buffer[index][5] == 'a')
			&& (buffer[index][6] == 'I' || buffer[index][6] == 'i')
			&& (buffer[index][7] == 'O' || buffer[index][7] == 'o')) {
		rv = demoFCYZXIaio(index);
	} else if ((buffer[index][5] == 'P' || buffer[index][5] == 'p')
			&& (buffer[index][6] == 'O' || buffer[index][6] == 'o')
			&& (buffer[index][7] == 'S' || buffer[index][7] == 's')
			&& (buffer[index][8] == '2')
			&& (buffer[index][9] == 'D' || buffer[index][9] == 'd')) {
		rv = demoFCYZXIpos2d(index);
	} else if ((buffer[index][5] == 'C' || buffer[index][5] == 'c')
			&& (buffer[index][6] == 'A' || buffer[index][6] == 'a')
			&& (buffer[index][7] == 'P' || buffer[index][7] == 'p')) {
...
//submit to demoF to handle message
		bmode = serverDetermineBlock(buffer[index]);
#ifdef DEBUGV
		printf("begin submitToDemoF,blockmode=%d\n", bmode);
#endif
		if (BLOCKMODE == bmode) {
			if (-1 == submitToDemoF(index, bmode)) {
#ifdef DEBUGV
...
#endif
		} else if (UNBLOCKMODE == bmode) {
			if (-1 == submitToDemoF(index, bmode)) {
#ifdef DEBUGV
				printf("server busy can't deal command,unblockmode!\n");
#endif
			}
#ifdef DEBUGV
			printf("submitToDemoF over !\n");
